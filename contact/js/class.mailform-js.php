			...
			$.ajax({
				...
				success: function( res ) {
					...
					if ( response[0] === 'send_success' ) {
						...
						$( 'form#mail_form' ).find( '.ipt' ).val("");
						$( 'form#mail_form' ).find('input:checkbox').removeAttr('checked');
						$( '#form_submit' ).append( '<span class="send-success">お問い合わせを受け付けました。<br>ありがとうございます。</span>' ).hide().fadeIn(1000);
						
						setTimeout(function() {
							$('span.send-success').fadeOut();
						}, 10000);
					} else {
