...
// 回答者への自動返信メール
$toReply = $_POST['mail_address'];
$subjectReply = '応募を受け付けました - プロトシステム';
$textReply = "こんにちは。プロトシステムです。
...
function sendMail( $to=null, $subject=null, $text=null, $file=null){
  ...
  if( $to === null || $subject === null || $text === null ) {
	...
	// 送信元の設定
    $sender_email = 'school@prsys.jp';
    $org = 'プロトシステム';
    $from = 'school@prsys.jp';
